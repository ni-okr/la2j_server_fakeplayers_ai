...
4.2 - Costume System Complete

### 🆕 Что нового в версии 4.2
- **Система костюмов в стиле Blade & Soul** - 8 слотов костюмов с 3D предварительным просмотром
- **Drag & Drop функциональность** - интуитивное управление костюмами
- **Система коллекций** - 4 темы (Classic, Fantasy, Modern, Seasonal)
- **UI гардероба** - современный интерфейс с фильтрацией и поиском
- **Интеграция с PBR** - реалистичные материалы для костюмов
